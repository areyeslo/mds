...
// Core Activities
export const STORE_CORE_ACTIVITIES = "STORE_CORE_ACTIVITIES";
export const STORE_USER_CORE_ACTIVITIES = "STORE_USER_CORE_ACTIVITIES";
export const STORE_CORE_ACTIVITY_TARGETS = "STORE_CORE_ACTIVITY_TARGETS";
